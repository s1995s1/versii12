...
if (!chat.isBanned && chat.audios && m.text.match(/(картинка)/gi)) {    
let vn = './media/картинка.jpg'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(музыка)/gi)) {    
let vn = './media/музыка.mp4'
this.sendPresenceUpdate('recording', m.chat)   
 this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

 if (!chat.isBanned && chat.audios && m.text.match(/(Жду|жду)/gi)) {    
let vn = './media/личка2.mp4'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
 ...
 if (!chat.isBanned && chat.audios && m.text.match(/(Новенький|новенький)/gi)) {    
let vn = './media/новенький.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

 if (!chat.isBanned && chat.audios && m.text.match(/(голос|Голос)/gi)) {    
let vn = './media/голос.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

 if (!chat.isBanned && chat.audios && m.text.match(/(Игноришь|игноришь)/gi)) {    
let vn = './media/гдее.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(Индусы|индусы|Индус|индус)/gi)) {    
let vn = './media/Индусы.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Что делаешь|что делаешь)/gi)) {    
let vn = './media/что делаешь.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}

if (!chat.isBanned && chat.audios && m.text.match(/(Пошли в лс|пошли в лс|В лс|в лс)/gi)) {    
...
if (!chat.isBanned && chat.audios && m.text.match(/(Цытата|цытата)/gi)) {    
let vn = './media/а1.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
...
if (!chat.isBanned && chat.audios && m.text.match(/(6вчопнаролнпг)/gi)) {    
let vn = './media/6.mp3'
this.sendPresenceUpdate('recording', m.chat)   
this.sendFile(m.chat, vn, 'error.mp3', null, m, true, {type: 'audioMessage', ptt: true})}
